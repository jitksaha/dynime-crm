    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('split_label', models.CharField(help_text='Name of the split type (e.g., Revenue, Overlay)', max_length=255, verbose_name='Split Label')),
                ('split_field', models.CharField(choices=[('amount', 'Opportunity - Amount'), ('expected_revenue', 'Opportunity - Expected Revenue')], default='amount', help_text='Field to split: amount, expected_revenue, etc.', max_length=100, verbose_name='Split Field')),
                ('totals_100_percent', models.BooleanField(default=True, help_text='Require splits of this type to total exactly 100%', verbose_name='Totals 100%')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.company', verbose_name='Company')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('split_percentage', models.DecimalField(blank=True, decimal_places=2, help_text='Percentage of total credit (e.g., 25.00 for 25%).', max_digits=6, null=True, verbose_name='Split Percentage')),
                ('split_amount', models.DecimalField(blank=True, decimal_places=2, help_text='Calculated split amount based on percentage and opportunity amount.', max_digits=15, null=True, verbose_name='Split Amount')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.company', verbose_name='Company')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='splits', to='opportunities.opportunity', verbose_name='Opportunity')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
                ('user', models.ForeignKey(help_text='User receiving credit for this split.', on_delete=django.db.models.deletion.CASCADE, related_name='opportunity_splits', to=settings.AUTH_USER_MODEL, verbose_name='Team Member')),
                ('split_type', models.ForeignKey(help_text='Type of split, such as Revenue or Overlay.', on_delete=django.db.models.deletion.CASCADE, related_name='splits', to='opportunities.opportunitysplittype', verbose_name='Split Type')),
            ],
            options={
                'verbose_name': 'Opportunity Split',
                'verbose_name_plural': 'Opportunity Splits',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='stage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='opportunities.opportunitystage', verbose_name='Stage'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.company', verbose_name='Company')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('team_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='team_role', to='core.teamrole', verbose_name='Member Role')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='default_team_role', to='core.teamrole', verbose_name='Member Role')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='opportunity_contact_roles', to='core.customerrole', verbose_name='Role')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('team_selling_enabled', models.BooleanField(default=False, help_text='Enable Opportunity Teams to help multiple users collaborate on opportunities. When enabled, you can define roles for team members, set record-level access, and view teams in list views and reports.', verbose_name='Enable Team Selling')),
                ('split_enabled', models.BooleanField(default=False, help_text='Allow multiple users to share credit for an opportunity. Splits can be based on revenue, overlay, or custom metrics.', verbose_name='Enable Opportunity Splits')),
                ('allow_all_users_in_splits', models.BooleanField(default=False, help_text='When enabled, users can assign splits to any active user in the company, not just opportunity team members. This allows adding new members while editing splits.', verbose_name='Let users add members to opportunity teams while editing splits')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.company', verbose_name='Company')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
